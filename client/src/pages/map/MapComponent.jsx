...
const MapComponent = () => {
  ...
  return (
    <div className="relative w-full h-[600px]">
      ...
      <div
        className="absolute top-20 mt-2 left-0 ml-3 cursor-pointer w-10 text-center rounded-[2px] border-2 bg-white"
      ...
      <button
        className="fixed bottom-[200px] right-2 bg-white rounded-full border-2 border-white w-[50px] h-[50px] flex items-center justify-center text-3xl shadow-md cursor-pointer p-2 "
        onClick={openModal}
      >
        <img src={filter_marker} alt="filter" />
      </button>
            ...
            {isModalOpen && (
              ...
              >
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                >
                  <h1 className="font-sans text-xl text-orange-400 p-0">
                    Filters
                  </h1>
                  <div className="flex justify-center p-[10px]">
                    <ul
                      className="list-none p-0 flex flex-wrap w-[500px] justify-center"
                      onClick={closeModal}
                    >
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("spots")}
                      >
                        Important Spots
                      </li>
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("beauty_salon")}
                      >
                        Beauty Salon
                      </li>
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("clothing_store")}
                      >
                        Clothing store
                      </li>
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("hair_care")}
                      >
                        Haircare
                      </li>
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("jewelry_store")}
                      >
                        Jwellery Store
                      </li>
                      <li
                      ...
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("shopping_mall")}
                      >
                        {" "}
                        Shopping Mall
                      </li>
                      <li
                        className="m-[5px] p-[5px] font-sans rounded-md bg-amber-100 cursor-pointer"
                        onClick={() => handleItemClick("police")}
                      >
                        Police
                      </li>
                      <li
