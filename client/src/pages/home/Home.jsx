...
const Home = () => {
  ...
  return (
    <div id="homemain" className="bg-fixed">
      ...
      <div>
        <div className="home-bd-main md:flex flex flex-col md:flex-row  w-auto justify-center  md:justify-evenly bg-custom-dark font-sans font-normal items-center pt-[15vh] text-white text-center md:text-start">
          <div className="hf1 flex flex-col mt-10 md:w-[40vw] w-screen">
            <p
              className="hh text-2xl md:text-4xl md:w-[34vw] w-screen flex justify-center md:justify-start font-sans font-normal md:leading-loose"
              id="hh"
            >
              Your One-stop Solution To every Problem
            </p>
            <img
              src={img2}
              alt=""
              className=" w-[250px] md:w-[300px] h-auto md:ml-[0.51vw] md:mt-[0vh] md:mb-[20px] md:p-[0]  p-[20px] md:justify-start justify-center mb-0 md:self-start self-center"
            />
          ...
          <div className="hfr flex items-center justify-center">
            <img
              src={img1}
              className="h-auto w-[400px] mt-[10vh] p-[20px] md:w-[500px]"
              alt=""
            />
          </div>
        </div>
        <div
          className="home-bod-second text-white pt-[20px]  md:pt-[70px] md:pr-[50px] flex flex-col items-center justify-center bg-custom-dark font-sans"
          id="services"
        >
          <p className="hs w-auto leading-10  flex font-sans md:text-4xl text-2xl justify-center text-center md:mt-[0] mt-[14px] ">
            Services We Provide
          </p>
        ...
        <div className="home-bod-secondlast flex items-center bg-custom-dark justify-evenly pt-[10vh]">
          ...
          <div className="hfl-def flex flex-col w-[40vw] text-white">
            <p className="hh text-2xl md:text-4xl md:w-[34vw] w-screen flex justify-center md:justify-start font-sans font-normal md:leading-loose">
