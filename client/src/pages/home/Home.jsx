...
const Home = () => {
  ...
  return (
    ...
    <div> 
      ...
      <div  className="home-bod-second text-white pt-[20px]  md:pt-[70px] md:pr-[50px] flex flex-col items-center justify-center bg-custom-dark font-sans" id="services">
        ...
        <div className="hss mt-[20px] md:mt-[40px]  md:flex flex flex-col md:flex-row  item-center justify-center md:justify-around gap-[60px]">
          <div className="hss-card w-[15rem] ring-2 ring-white ring-offset-10  md:w-[20vw] h-[380px] mb-2 md:h-[400px] flex flex-col items-center bg-slate-500  rounded-[10px]  ">
            ...
            <a className="bl cursor-pointer font-normal text-center text-lg text-white p-[10px] border-b-1 font-sans" href="/meds">
