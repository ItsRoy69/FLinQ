        ...
        <div className='container bg-slate-900 min-h-screen font-sans text-white'>
            <div className='divide-y divide-solid px-4 w-full h-full'>
                ...
                <div className='flex flex-col items-start w-full p-0 m-0 mb-5' >
                    <ul className='mt-2'>
                       <div className='flex justify-between items-start '>
                            <div><li className='flex m-2 font-sans text-xl'><span className='mr-4'><FontAwesomeIcon icon={faMapLocationDot} className='px-2 h-6 w-6'/></span>Address</li></div>
                            <div><span className='ml-auto absolute m-2 right-5'><FontAwesomeIcon icon={faAngleRight}/></span></div>
                       </div>
                       <div className='flex justify-between items-start '>
                            <div><li className='flex m-2 font-sans text-xl'><span className='mr-4'><FontAwesomeIcon icon={faLock} className='px-2 h-6 w-6'/></span>Change Password</li></div>
                            <div><span className='ml-auto absolute m-2 right-5'><FontAwesomeIcon icon={faAngleRight}/></span></div>
                       </div>
                    </ul>
                </div>
                <div className='flex flex-col items-start w-full p-0 m-0 mb-5' >
                    <ul className='mt-2'>
                    <div className='flex justify-between items-start '>
                            <div><li className='flex m-2 font-sans text-xl'><span className='mr-4'><FontAwesomeIcon icon={faCircleQuestion} className='px-2 h-6 w-6'/></span>Help and Support</li></div>
                            <div><span className='ml-auto absolute m-2 right-5'><FontAwesomeIcon icon={faAngleRight}/></span></div>
                       </div>
                       <div className='flex justify-between items-start '>
