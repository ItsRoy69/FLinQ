...
const ChatPromptWindow = ({
  ...
  return (
    <>
      <div className="w-screen h-[calc(100vh-3.5rem)] absolute bottom-14 left-0 flex flex-col justify-start items-center pt-20 z-10 backdrop-blur-xl overflow-hidden">
        <div
          id="chat-prompt-box"
          className="w-full h-full dark:bg-custom-dark dark:text-white px-5 py-5 flex flex-col gap-4 rounded-t-3xl"
        >
              ...
              <>
                ...
                >
                  <div className="flex flex-col py-3 justify-between w-full h-full">
                    ...
                    <p className="text-sm">
                      Chat with your profile unrevealed...
                    </p>
                  </div>
                  <NoAccountsRoundedIcon fontSize="large" />
                </div>
              </>
            )}
          </div>
